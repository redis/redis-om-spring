...
class OpsForCountMinSketchTest extends AbstractBaseDocumentTest {
  ...
  void testInitByProb() {
    ...
    assertEquals(Long.valueOf(200L), info.get("width"));
    assertEquals(Long.valueOf(7L), info.get("depth"));
    assertEquals(Long.valueOf(0L), info.get("count"));
  }
  ...
  void testIncrBy() {
    ...
    assertEquals(Long.valueOf(1000L), info.get("width"));
    assertEquals(Long.valueOf(5L), info.get("depth"));
    assertEquals(Long.valueOf(5L), info.get("count"));
  }
