...
public class ObjectUtilsTest extends AbstractBaseDocumentTest {
  ...
  void testGetTargetClassName() throws NoSuchFieldException, SecurityException, NoSuchMethodException {
    ...
    assertThat(ObjectUtils.getTargetClassName("java.util.List<com.redis.om.spring.annotations.document.fixtures.Attribute>")).isEqualTo(List.class.getTypeName());
  }
  ...
  void testGetIdFieldForEntity() {
    Company redis = companyRepository.save(Company.of("RedisInc", 2011, LocalDate.of(2021, 5, 1), new Point(-122.066540, 37.377690), "stack@redis.com"));
  ...
  void testUnQuote() {
    ...
    assertThat(ObjectUtils.unQuote("Spam")).isEqualTo("Spam");
    assertThat(ObjectUtils.unQuote("\"The quick \\\"brown\\\" fox \\\"jumps\\\" over the lazy dog\"")).isEqualTo("The quick \\\"brown\\\" fox \\\"jumps\\\" over the lazy dog");
  }
