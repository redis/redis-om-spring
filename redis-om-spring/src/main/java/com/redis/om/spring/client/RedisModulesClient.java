...
public class RedisModulesClient {
  ...
  private JedisClientConfig createClientConfig(int database, @Nullable String username, @Nullable RedisPassword password, JedisClientConfiguration clientConfiguration) {
