...
/**
 * An implementation class of a {@link TupleMapper } of degree 10
 * <p>
 ...
 */
public final class Tuple10MapperImpl<T, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>
...
implements TupleMapper<T, Decuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>> {
    ...
    /**
     * Constructs a {@link TupleMapper } that can create {@link Decuple }.
     *
