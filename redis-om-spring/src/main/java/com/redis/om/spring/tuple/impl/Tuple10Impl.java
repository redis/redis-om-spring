...
/**
 * An implementation class of a {@link Decuple}.
 * <p>
 ...
 */
public final class Tuple10Impl<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>
extends AbstractTuple
implements Decuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> {

    /**
     * Constructs a {@link Tuple} of type {@link Decuple}.
     *
     * @param e0 element 0
     * @param e1 element 1
     * @param e2 element 2
    ...
    public Tuple10Impl(
            ...
            T8 e8,
            T9 e9) {
        super(Tuple10Impl.class, e0, e1, e2, e3, e4, e5, e6, e7, e8, e9);
    }
