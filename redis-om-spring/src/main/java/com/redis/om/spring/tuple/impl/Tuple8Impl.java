...
/**
 * An implementation class of a {@link Octuple}.
 * <p>
 ...
 */
public final class Tuple8Impl<T0, T1, T2, T3, T4, T5, T6, T7>
extends AbstractTuple
implements Octuple<T0, T1, T2, T3, T4, T5, T6, T7> {

    /**
     * Constructs a {@link Tuple} of type {@link Octuple}.
     *
     * @param e0 element 0
     * @param e1 element 1
     * @param e2 element 2
    ...
    public Tuple8Impl(
            ...
            T6 e6,
            T7 e7) {
        super(Tuple8Impl.class, e0, e1, e2, e3, e4, e5, e6, e7);
    }
