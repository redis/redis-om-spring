...
/**
 * An implementation class of a {@link Duodecuple}.
 * <p>
 ...
 */
public final class Tuple12Impl<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
extends AbstractTuple
implements Duodecuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> {

    /**
     * Constructs a {@link Tuple} of type {@link Duodecuple}.
     *
     * @param e0  element 0
     * @param e1  element 1
     * @param e2  element 2
    ...
    public Tuple12Impl(
            ...
            T10 e10,
            T11 e11) {
        super(Tuple12Impl.class, e0, e1, e2, e3, e4, e5, e6, e7, e8, e9, e10, e11);
    }
