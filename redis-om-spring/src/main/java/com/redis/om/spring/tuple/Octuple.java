 ...
 * @see MutableTuple
 */
public interface Octuple<T0, T1, T2, T3, T4, T5, T6, T7> extends Tuple {
   ...
   */
  static <T0, T1, T2, T3, T4, T5, T6, T7> TupleGetter0<Octuple<T0, T1, T2, T3, T4, T5, T6, T7>, T0> getter0() {
    return Octuple::get0;
  }
   ...
   * @param <T7> the 7th element type
   */
  static <T0, T1, T2, T3, T4, T5, T6, T7> TupleGetter1<Octuple<T0, T1, T2, T3, T4, T5, T6, T7>, T1> getter1() {
    return Octuple::get1;
  }
   ...
   * @param <T7> the 7th element type
   */
  static <T0, T1, T2, T3, T4, T5, T6, T7> TupleGetter2<Octuple<T0, T1, T2, T3, T4, T5, T6, T7>, T2> getter2() {
    return Octuple::get2;
  }
   ...
   * @param <T7> the 7th element type
   */
  static <T0, T1, T2, T3, T4, T5, T6, T7> TupleGetter3<Octuple<T0, T1, T2, T3, T4, T5, T6, T7>, T3> getter3() {
    return Octuple::get3;
  }
   ...
   * @param <T7> the 7th element type
   */
  static <T0, T1, T2, T3, T4, T5, T6, T7> TupleGetter4<Octuple<T0, T1, T2, T3, T4, T5, T6, T7>, T4> getter4() {
    return Octuple::get4;
  }
   ...
   * @param <T7> the 7th element type
   */
  static <T0, T1, T2, T3, T4, T5, T6, T7> TupleGetter5<Octuple<T0, T1, T2, T3, T4, T5, T6, T7>, T5> getter5() {
    return Octuple::get5;
  }
   ...
   * @param <T7> the 7th element type
   */
  static <T0, T1, T2, T3, T4, T5, T6, T7> TupleGetter6<Octuple<T0, T1, T2, T3, T4, T5, T6, T7>, T6> getter6() {
    return Octuple::get6;
  }
   ...
   * @param <T7> the 7th element type
   */
  static <T0, T1, T2, T3, T4, T5, T6, T7> TupleGetter7<Octuple<T0, T1, T2, T3, T4, T5, T6, T7>, T7> getter7() {
    return Octuple::get7;
  }
}