...
public class RedisStreamConsumerRegistrar extends RedisStreamConsumerBeanDefinitionRegistrarSupport {
    ...
    private void registerConsumerBeans(Class<?> consumerClass, RedisStreamConsumer annotation, BeanDefinitionRegistry registry) {
        ...
        logger.info("Registering beans for consumer: {} with topic: {}, group: {}, autoAck: {}, cluster: {}", 
                   consumerClass.getSimpleName(), topicName, groupName, autoAck, cluster);
    ...
    private void registerConsumerGroup(String topicName, String groupName, Class<?> consumerClass, BeanDefinitionRegistry registry) {
    ...
    private void registerNoAckConsumerGroup(String topicName, String groupName, Class<?> consumerClass, BeanDefinitionRegistry registry) {
    ...
    private void registerSingleClusterPelConsumerGroup(String topicName, String groupName, Class<?> consumerClass, BeanDefinitionRegistry registry) {
