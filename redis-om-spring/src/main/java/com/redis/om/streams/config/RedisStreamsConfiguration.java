...
@Configuration
@EnableScheduling
@Conditional(RedisStreamsCondition.class)
public class RedisStreamsConfiguration {
    ...
    @Bean
    public DefaultNoAckRedisStreamsMessageHandler redisStreamsHandler(TopicManager topicManager, NoAckConsumerGroup consumerGroup) {
