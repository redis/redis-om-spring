...
[source,java]
----
// From demos/roms-multitenant/src/main/java/com/redis/om/multitenant/domain/Product.java
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
...
The `TenantService` provides the current tenant via ThreadLocal:

[source,java]
----
// From demos/roms-multitenant/src/main/java/com/redis/om/multitenant/services/TenantService.java
@Service
