...
public class DetachedEntityStreamHashTest extends AbstractBaseEnhancedRedisTest {
  ...
  void beforeEach() {
    ...
    Bicycle[] bicycles = { new Bicycle("hashbike:0", "Velorim", "Jigger", 270.0, "new",
        ...
        new Bicycle("hashbike:1", "Bicyk", "Hillcraft", 1200.0, "used",
        ...
        new Bicycle("hashbike:2", "Nord", "Chook air 5", 815.0, "used",
        ...
        new Bicycle("hashbike:3", "Eva", "Eva 291", 3400.0, "used",
        ...
        new Bicycle("hashbike:4", "Noka Bikes", "Kahuna", 3200.0, "used",
            "Whether you want to try your hand at XC racing or are " + "looking for a lively trail bike that's just as inspiring" + " on the climbs as it is over rougher ground, the Wilder" + " is one heck of a bike built specifically for short women." + " Both the frames and components have been tweaked to " + "include a women’s saddle, different bars and unique " + "colourway."),
        new Bicycle("hashbike:5", "Breakout", "XBN 2.1 Alloy", 810.0, "new",
        ...
        new Bicycle("hashbike:6", "ScramBikes", "WattBike", 2300.0, "new",
        ...
        new Bicycle("hashbike:7", "Peaknetic", "Secto", 430.0, "new",
        ...
        new Bicycle("hashbike:8", "nHill", "Summit", 1200.0, "new",
        ...
        new Bicycle("hashbike:9", "ThrillCycle", "BikeShind", 815.0, "refurbished",
