...
public class DetachedEntityStreamDocsTest extends AbstractBaseDocumentTest {
  ...
  void beforeEach() {
    ...
    jedis.ftCreate("idx:bicycle", FTCreateParams.createParams().on(IndexDataType.JSON).addPrefix("bicycle:"), schema);

    Bicycle[] bicycles = { new Bicycle("bicycle:0", "Velorim", "Jigger", new BigDecimal(270), "new",
        ...
        new Bicycle("bicycle:1", "Bicyk", "Hillcraft", new BigDecimal(1200), "used",
            "Kids want to ride with as little weight as possible." + " Especially on an incline! They may be at the age " + "when a 27.5 inch wheel bike is just too clumsy coming " + "off a 24 inch bike. The Hillcraft 26 is just the solution" + " they need!"),
        new Bicycle("bicycle:2", "Nord", "Chook air 5", new BigDecimal(815), "used",
        ...
        new Bicycle("bicycle:3", "Eva", "Eva 291", new BigDecimal(3400), "used",
        ...
        new Bicycle("bicycle:4", "Noka Bikes", "Kahuna", new BigDecimal(3200), "used",
            "Whether you want to try your hand at XC racing or are " + "looking for a lively trail bike that's just as inspiring" + " on the climbs as it is over rougher ground, the Wilder" + " is one heck of a bike built specifically for short women." + " Both the frames and components have been tweaked to " + "include a women’s saddle, different bars and unique " + "colourway."),
        new Bicycle("bicycle:5", "Breakout", "XBN 2.1 Alloy", new BigDecimal(810), "new",
        ...
        new Bicycle("bicycle:6", "ScramBikes", "WattBike", new BigDecimal(2300), "new",
        ...
        new Bicycle("bicycle:7", "Peaknetic", "Secto", new BigDecimal(430), "new",
        ...
        new Bicycle("bicycle:8", "nHill", "Summit", new BigDecimal(1200), "new",
        ...
        new Bicycle("bicycle:9", "ThrillCycle", "BikeShind", new BigDecimal(815), "refurbished",
