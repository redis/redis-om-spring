...
class BasicRedisDocumentMappingTest extends AbstractBaseDocumentTest {
  ...
  @Autowired
  NotNullAnnotatedRepository notNullAnnotatedRepository;
  ...
  void cleanUp() {
    ...
    if (notNullAnnotatedRepository.count() == 0) {
      NotNullAnnotated nna1 = new NotNullAnnotated("001", "This");
      NotNullAnnotated nna2 = new NotNullAnnotated("002", "is");
      NotNullAnnotated nna3 = new NotNullAnnotated("003", "not");
      NotNullAnnotated nna4 = new NotNullAnnotated("004", "normal");
      var entities = List.of(nna1, nna2, nna3, nna4);
  ...
  @Test
  void testEffectOfNotNullAnnotation() {
    // here we are just testing that the DB_ID field is generated by the metamodel generator
    var fields = notNullAnnotatedRepository.getFieldsByIds(List.of("001"), NotNullAnnotated$.DB_ID);
