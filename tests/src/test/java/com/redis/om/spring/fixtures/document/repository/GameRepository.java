...
@SuppressWarnings(
  { "unused", "SpellCheckingInspection", "SpringDataRepositoryMethodReturnTypeInspection" }
)
public interface GameRepository extends RedisDocumentRepository<Game, String> {
  ...
  @Aggregation(
      ...
      groupBy = { //
          @GroupBy(
              ...
              properties = "@brand", //
              reduce = { @Reducer(
                  func = ReducerFunction.COUNT, alias = "count"
              ) } //
          ) //
      }, //
      sortBy = { //
  ...
  @Aggregation(
      ...
      groupBy = { //
          @GroupBy(
              ...
              reduce = { //
                  @Reducer(
                      func = ReducerFunction.COUNT
                  ), //
                  @Reducer(
                      func = ReducerFunction.MIN, args = { "@price" }, alias = "minPrice"
                  ) } //
          ) //
      }, //
      sortBy = { //
          @SortBy(
              field = "@minPrice", direction = Direction.DESC
          ), //
      }
  )
  //
  ...
  //
  AggregationResult minPricesByBrand(@Param(
    "brand"
  ) String brand);
      ...
      groupBy = { //
          @GroupBy(
              ...
              reduce = { //
                  ...
                  @Reducer(
                      func = ReducerFunction.MAX, args = { "@price" }, alias = "maxPrice"
                  ) } //
          ) //
      }, //
      sortBy = { //
          @SortBy(
              field = "@maxPrice", direction = Direction.DESC
          ), //
      }
  )
  //
  ...
  @Aggregation(
      ...
      groupBy = { //
          @GroupBy(
              ...
              reduce = { //
                  @Reducer(
                      func = ReducerFunction.COUNT_DISTINCT, args = { "@title" }, alias = "count_distinct(title)"
                  ), //
                  @Reducer(
                      func = ReducerFunction.COUNT
                  ) //
      ...
      sortBy = { //
          @SortBy(
              field = "@count_distinct(title)", direction = Direction.DESC
          ), //
      }, limit = 5
  )
  //
  ...
  @Aggregation(
      ...
      groupBy = { //
          @GroupBy(
              ...
              reduce = { //
                  @Reducer(
                      func = ReducerFunction.QUANTILE, args = { "@price", "0.50" }, alias = "q50"
                  ),
                  //
                  @Reducer(
                      func = ReducerFunction.QUANTILE, args = { "@price", "0.90" }, alias = "q90"
                  ),
                  //
                  @Reducer(
                      func = ReducerFunction.QUANTILE, args = { "@price", "0.95" }, alias = "q95"
                  ),
                  //
                  @Reducer(
                      func = ReducerFunction.AVG, args = { "@price" }
                  ), //
                  @Reducer(
                      func = ReducerFunction.COUNT, alias = "rowcount"
                  ) //
              } //
          ) //
      }, //
      sortBy = { //
          @SortBy(
              field = "@rowcount", direction = Direction.DESC
          ), //
      }, sortByMax = 1 //
  )
  //
  ...
  @Aggregation(
      ...
      groupBy = { //
          @GroupBy(
              ...
              reduce = { //
                  @Reducer(
                      func = ReducerFunction.STDDEV, args = { "@price" }, alias = "stddev(price)"
                  ),
                  //
                  @Reducer(
                      func = ReducerFunction.AVG, args = { "@price" }, alias = "avgPrice"
                  ), //
                  @Reducer(
  ...
  @Aggregation(
      ...
      apply = { //
          @Apply(
              expression = "timefmt(1517417144)", alias = "dt"
          ), //
          @Apply(
              expression = "parsetime(@dt, \"%FT%TZ\")", alias = "parsed_dt"
          ), //
      }, //
      limit = 1 //
  )
  ...
  @Aggregation(
      ...
      groupBy = { //
          @GroupBy(
              ...
              reduce = { //
                  @Reducer(
                      func = ReducerFunction.COUNT, alias = "num"
                  ), //
                  @Reducer(
      ...
      sortBy = { //
          @SortBy(
              field = "@num", direction = Direction.DESC
          ), //
      }, sortByMax = 10
  )
  //
  ...
  @Aggregation(
      //
      apply = { @Apply(
          expression = "1517417144", alias = "dt"
      ), //
          @Apply(
              expression = "timefmt(@dt)", alias = "timefmt"
          ), //
          @Apply(
              expression = "day(@dt)", alias = "day"
          ), //
          @Apply(
              expression = "hour(@dt)", alias = "hour"
          ), //
          @Apply(
              expression = "minute(@dt)", alias = "minute"
          ), //
          @Apply(
              expression = "month(@dt)", alias = "month"
          ), //
          @Apply(
              expression = "dayofweek(@dt)", alias = "dayofweek"
          ), //
          @Apply(
              expression = "dayofmonth(@dt)", alias = "dayofmonth"
          ), //
          @Apply(
              expression = "dayofyear(@dt)", alias = "dayofyear"
          ), //
          @Apply(
              expression = "year(@dt)", alias = "year"
          ), //
      }, limit = 1
  )
  //
      ...
      groupBy = { //
          @GroupBy(
              ...
              reduce = { //
                  ...
                  @Reducer(
                      func = ReducerFunction.MAX, args = { "@price" }, alias = "price"
                  ) //
              } //
          ) //
      }, //
  ...
  @Aggregation(
      ...
      groupBy = { //
          @GroupBy(
              ...
              reduce = { //
                  ...
                  @Reducer(
                      func = ReducerFunction.SUM, args = { "@price" }, alias = "sum(price)"
                  ) //
              } //
          ) //
      }, //
      sortBy = { //
          @SortBy(
              field = "@sum(price)", direction = Direction.DESC
          ), //
      }, limit = 5 //
  )
  //
  ...
  @Aggregation(
      ...
      groupBy = { //
          @GroupBy(
              ...
              reduce = { //
                  @Reducer(
                      func = ReducerFunction.COUNT_DISTINCT, args = "@price", alias = "count"
                  ), //
                  @Reducer(
                      func = ReducerFunction.TOLIST, args = "@price", alias = "prices"
                  ) //
              } //
          ) //
      }, //
  ...
  @Aggregation(
      ...
      groupBy = { //
          @GroupBy(
              ...
              properties = { "@brand" }, //
              reduce = { @Reducer(
                  func = ReducerFunction.SUM, args = "@price", alias = "price"
              ) } //
          ) //
      }, //
      apply = { @Apply(
          expression = "(@price % 10)", alias = "price"
      ) }, //
      sortBy = { //
          @SortBy(
              field = "@price", direction = Direction.ASC
          ), //
          @SortBy(
              field = "@brand", direction = Direction.DESC
          ), //
      }, sortByMax = 10
  )
  //
  ...
  @Aggregation(
      ...
      load = @Load(
          ...
          field = "@price", direction = Direction.DESC
      ), limit = 2
  )
  //
  ...
  /**
   * <pre>
   * "FT.AGGREGATE" "com.redis.om.spring.annotations.document.fixtures.GameIdx" "@brand:(sony|matias|beyerdynamic|(mad
   * catz))"
   * "GROUPBY" "1" "@brand"
  ...
  @Aggregation(
      ...
      value = "@brand:(sony|matias|beyerdynamic|(mad catz))", groupBy = { //
          @GroupBy(
              ...
              reduce = { //
                  @Reducer(
                      func = ReducerFunction.FIRST_VALUE, args = { "@title", "@price", "DESC" }, alias = "top_item"
                  ), @Reducer(
      ...
      sortBy = @SortBy(
          field = "@top_price", direction = Direction.DESC
      ), //
      sortByMax = 5 //
  )
  //
