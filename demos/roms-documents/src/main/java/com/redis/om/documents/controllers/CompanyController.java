...
public class CompanyController {
  ...
  Iterable<Company> byNumberOfEmployees(@PathVariable(
    "count"
  ) int count) {
  ...
  @GetMapping(
    "employees/range/{low}/{high}"
  )
  Iterable<Company> byNumberOfEmployeesRange(@PathVariable(
    "low"
  ) int low, @PathVariable(
    "high"
  ) int high) {
  ...
  Iterable<Company> byNameStartingWith(@PathVariable(
    "prefix"
  ) String prefix) {
  ...
  Optional<Company> byName(@PathVariable(
    "name"
  ) String name) {
  ...
  Optional<Company> byId(@PathVariable(
    "id"
  ) String id) {
