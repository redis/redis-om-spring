...
@DisabledIfEnvironmentVariable(named = "GITHUB_ACTIONS", matches = "true", disabledReason = "Skipping tests in the GitHub workflow because they interact with the embedding providers' API, which requires an API token.")
public class TestTextDataController {
    ...
    public void testFindByRightName() {
        ...
        ResponseEntity<TextData> response = restTemplate.getForEntity(uri + "findByName/" + textData.getName(), TextData.class);
        logger.info("TextData: {}", response.getBody());
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(response.getBody()).isNotNull();
        assertThat(response.getBody().getId()).isEqualTo(saved.getId());
    ...
    public void testFindByRightYear() {
        ...
        ResponseEntity<TextData[]> response = restTemplate.getForEntity(uri + "findByYear/" + textData.getYear(), TextData[].class);
    ...
    public void testFindByRightYearBetween() {
        ...
        ResponseEntity<TextData[]> response = restTemplate.getForEntity(uri + "findByYearBetween/2024/2026", TextData[].class);
        logger.info("TextData: {}", (Object[]) response.getBody());
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(response.getBody()).isNotNull();
        assertThat(response.getBody()[0].getId()).isEqualTo(saved.getId());
    ...
    public void testFindByWrongYearBetween() {
        ...
        ResponseEntity<TextData[]> response = restTemplate.getForEntity(uri + "findByYearBetween/2014/2016", TextData[].class);
        logger.info("TextData: {}", (Object[]) response.getBody());
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
        assertThat(response.getBody()).isNull();
    }
    ...
    public void testFindByRightScore() {
        ...
        ResponseEntity<TextData[]> response = restTemplate.getForEntity(uri + "findByScore/" + textData.getScore(), TextData[].class);
        logger.info("TextData: {}", (Object[]) response.getBody());
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(response.getBody()).isNotNull();
        assertThat(response.getBody()[0].getId()).isEqualTo(saved.getId());
    ...
    public void testFindByRightScoreBetween() {
        ...
        ResponseEntity<TextData[]> response = restTemplate.getForEntity(uri + "findByScoreBetween/63.00/64.00", TextData[].class);
        logger.info("TextData: {}", (Object[]) response.getBody());
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(response.getBody()).isNotNull();
        assertThat(response.getBody()[0].getId()).isEqualTo(saved.getId());
    ...
    public void testFindByWrongScoreBetween() {
        ...
        ResponseEntity<TextData[]> response = restTemplate.getForEntity(uri + "findByScoreBetween/50.50/60.60", TextData[].class);
        logger.info("TextData: {}", (Object[]) response.getBody());
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
        assertThat(response.getBody()).isNull();
    }
    ...
    public void testFindBySemanticSearch() {
        ...
        ResponseEntity<TextData[]> response = restTemplate.postForEntity(uri + "semanticSearch", "Are there any TextData description?", TextData[].class);
        logger.info("TextData: {}", (Object[]) response.getBody());
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(response.getBody()).isNotNull();
        assertThat(response.getBody()[0].getId()).isEqualTo(saved.getId());
