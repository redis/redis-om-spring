...
public class PermitController {
  ...
  Iterable<Permit> byConstructionValue(@PathVariable(
    "value"
  ) long value) {
  ...
  Iterable<Permit> fullTextSearch(@PathVariable(
    "q"
  ) String q) {
  ...
  Iterable<Permit> byBuildingType(@PathVariable(
    "type"
  ) String type) {
  ...
  Iterable<Permit> byCity(@PathVariable(
    "city"
  ) String city) {
  ...
  Iterable<Permit> byTags(@RequestParam(
    "types"
  ) Set<String> wts) {
  ...
  Iterable<Permit> byAllTags(@RequestParam(
    "types"
  ) Set<String> wts) {
  ...
  Iterable<Permit> byBuildingTypeAndDescription(@RequestParam(
    "buildingType"
  ) String buildingType, //
      @RequestParam(
        "description"
  ...
  Iterable<Permit> byCityOrDescription(@RequestParam(
    "city"
  ) String city, //
      @RequestParam(
        "description"
